...
export class Jet {
    ...
    __attach_auth() {
        if (this.interceptWithJWTAuth) {
            ...
            if (auth) {
                this.headers = Object.assign(Object.assign({}, this.headers), auth);
            }
        }
        return this.headers;
    }
    ...
    _populateData(type = 'GET', body, headers, configs, secure = false) {
        ...
        if (secure) {
            ...
            newConfigs = Object.assign(Object.assign({}, newConfigs), this.__attach_auth());
        }
        return Object.assign({}, newConfigs);
    }
    ...
    autoDetectServiceAndAction(_data) {
